#!/usr/bin/env python3
"""Validate repository-resident one-shot Continuous Curve Geometry authorization."""
...
KIND = "continuous-curve-geometry-regression-execution-authorization"
AUTHORIZATION = "EXECUTE_ONCE"
EXECUTION_WORKFLOW = ".github/workflows/continuous-curve-geometry-regression-execute.yml"
AUDIT_STATUS = "PASS / PREPARED / NOT EXECUTED"

_SHA256 = re.compile(r"^[0-9a-f]{64}$")
_COMMIT = re.compile(r"^[0-9a-f]{40}$")
_AUDIT_PATH = re.compile(
    r"^docs/audits/[A-Za-z0-9._-]+continuous-curve-geometry-regression"
    r"[A-Za-z0-9._-]*preparation-audit\.(?:json|md)$"
)
...
def validate_authorization(
    ...
    expected_name = f"continuous-curve-geometry-regression-{manifest}.json"
...
def write_github_output(
    ...
    rows = {
        ...
        "preparation_seal_sha256": value["preparation_seal_sha256"],
        "claim_tag": f"cgr-execution-claim-{manifest}",
    }
